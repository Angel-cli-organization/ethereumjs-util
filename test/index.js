...
describe('isValidPrivate', function() {
  const SECP256K1_N = new ethUtils.BN(
...
describe('generateAddress', function() {
  it('should produce an address given a public key', function() {
    const add = ethUtils
      .generateAddress('990ccf8a0de58091c028d6ff76bb235ee67c1c39', 14)
      .toString('hex')
...
describe('generateAddress with hex prefix', function() {
  it('should produce an address given a public key', function() {
    const add = ethUtils
      .generateAddress('0x990ccf8a0de58091c028d6ff76bb235ee67c1c39', 14)
      .toString('hex')
...
describe('generateAddress with nonce 0 (special case)', function() {
  it('should produce an address given a public key', function() {
    const add = ethUtils
      .generateAddress('0x990ccf8a0de58091c028d6ff76bb235ee67c1c39', 0)
      .toString('hex')
...
describe('isPrecompiled', function() {
  it('should return true', function() {
    ...
    assert.equal(
      ethUtils.isPrecompiled(Buffer.from('0000000000000000000000000000000000000001', 'hex')),
      true,
    )
  })
  it('should return false', function() {
    ...
    assert.equal(
      ethUtils.isPrecompiled(Buffer.from('0000000000000000000000000000000000000000', 'hex')),
      false,
    )
  })
})
...
describe('.isValidChecksumAddress()', function() {
  ...
  it('should validate', function() {
    assert.equal(
      ethUtils.isValidChecksumAddress('0x2f015c60e0be116b1f0cd534704db9c92118fb6a'),
      false,
    )
  })
})
...
describe('message sig', function() {
  ...
  it('pad short r and s values', function() {
    assert.equal(
      ethUtils.toRpcSig(27, r.slice(20), s.slice(20)),
